    ...
    "Benchmark": [
      ...
      },
      {
        "commit": {
          ...
          "url": "https://github.com/open-telemetry/otel-arrow/commit/f7ff5155cea816289b8916cb0035e349ac7263fb"
        },
        "date": 1781657451815,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "url": "https://github.com/open-telemetry/otel-arrow/commit/105dc7add1ae55f3412e439815c5df6fdfc07ee4"
        },
        "date": 1781743908843,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "url": "https://github.com/open-telemetry/otel-arrow/commit/bdd514ccf95d7fbac61746c699c0ebc295eed900"
        },
        "date": 1782780389681,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "url": "https://github.com/open-telemetry/otel-arrow/commit/9b6ee5b909a7a416bafbe185f4c3aee07ea283ad"
        },
        "date": 1782866899801,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "url": "https://github.com/open-telemetry/otel-arrow/commit/ca4ad7ef5cce0ae7472d69df8a141acf49252692"
        },
        "date": 1786104025895,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          "author": {
            "email": "77166319+IgorSiemek@users.noreply.github.com",
            "name": "IgorSiemek",
            "username": "IgorSiemek"
          },
          "committer": {
          ...
          "distinct": false,
          "id": "4511dd4b8437154871224ee677a547b06e6b1f8e",
          "message": "fix(engine): report pending metrics after processor errors (#3675)\n\n## Change Summary\n\nEnsure processor finalization still runs when `Processor::process`\nreturns an error.\n\nPending flow metrics and processor-local telemetry are reported before\nreturning the original error for both local and shared processor\nruntimes.\n\n## What issue does this PR close?\n\nFixes #3632.\n\n## How are these changes tested?\n\n- Added regression tests for local and shared processors\n- Verified pending flow metrics and processor telemetry are reported\n- Verified the original processing error takes precedence over final\ntelemetry errors\n\n## Are there any user-facing changes?\n\nYes. Pending processor and flow metrics are no longer lost after a\nprocessing error.\n\n### Changelog\n\n- [x] Added a `.chloggen/*.yaml` entry\n- [ ] This PR is a `chore`\n- [ ] This is a documentation-only PR\n\n---------\n\nCo-authored-by: Copilot Autofix powered by AI <175728472+Copilot@users.noreply.github.com>\nCo-authored-by: albertlockett <a.lockett@f5.com>",
          "timestamp": "2026-08-07T15:18:54Z",
          "tree_id": "0fff85110b2c9acd3cee3b9f726709efc2821959",
          "url": "https://github.com/open-telemetry/otel-arrow/commit/4511dd4b8437154871224ee677a547b06e6b1f8e"
        },
        "date": 1786120410840,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": false,
          "id": "59054e2c5103d99800db6eb184e8f4d9d40fec2e",
          "message": "fix(engine): remove unreachable processor_chain node kind (#3680)\n\n# Change Summary\n\n`NodeKind::ProcessorChain` was a placeholder that no configuration could\never produce: the node URN parser only accepts `receiver`, `processor`,\nand `exporter`, and `NodeUserConfig::kind()` derives the kind from the\nparsed URN. Every engine match arm for it was therefore dead, including\ntwo `UnsupportedNodeKind` returns and one `unreachable!`.\n\n## What issue does this PR close?\n\n<!--We highly recommend correlation of every PR to an issue-->\n\n* Closes #2556 \n\n## How are these changes tested?\n\n## Are there any user-facing changes?\n\n <!-- If yes, provide further info below -->\n\n### Changelog\n\n<!--\nUser-facing changes need a .chloggen/*.yaml entry. Copy the\nTEMPLATE.yaml\nin go/.chloggen/ or rust/otap-dataflow/.chloggen/ and fill in the\nfields.\nIf not required, include `chore` in the PR title.\n-->\n\n* [x] Added a `.chloggen/*.yaml` entry\n* [ ] This PR is a `chore` (indicated in title)\n* [ ] This is a documentation-only PR.\n\nCo-authored-by: Utkarsh Umesan Pillai <66651184+utpilla@users.noreply.github.com>",
          "timestamp": "2026-08-07T15:55:54Z",
          "tree_id": "6792901c8f4230256acfc4250516718527b98938",
          "url": "https://github.com/open-telemetry/otel-arrow/commit/59054e2c5103d99800db6eb184e8f4d9d40fec2e"
        },
        "date": 1786122322506,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "09793c718a89e7c3a34f4c9238a890a33834acd4",
          "message": "feat: Implement oauth2-clientauth extension (#3657)\n\n# Change Summary\n\n- Adds the `oauth2_client_auth` extension, which acquires and refreshes\nOAuth 2.0\naccess tokens over the client-credentials and JWT-bearer grants and\nexposes them\nto data-path nodes through the existing `BearerTokenProvider`\ncapability, with\nTLS/mTLS to the token endpoint and credentials supplied inline or via\nfiles that\nare re-read on each acquisition so they rotate without a restart. \n- It also factors the token cache, refresh loop, and capability\nimplementation out of\n`azure_identity_auth` into a shared `common::token_refresh` module that\nboth\nextensions now alias.\n\n## What issue does this PR close?\n\n* Related to #3479\n\n## How are these changes tested?\n\n- Unit tests\n- Local integration test with OTLP HTTP Exporter and Keycloak on an AKS\ncluster\n\n## Are there any user-facing changes?\n\nYes, the new OAuth extension can now be used with OTLP HTTP exporter\n\n### Changelog\n\n<!--\nUser-facing changes need a .chloggen/*.yaml entry. Copy the\nTEMPLATE.yaml\nin go/.chloggen/ or rust/otap-dataflow/.chloggen/ and fill in the\nfields.\nIf not required, include `chore` in the PR title.\n-->\n\n* [x] Added a `.chloggen/*.yaml` entry\n* [ ] This PR is a `chore` (indicated in title)\n* [ ] This is a documentation-only PR.",
          "timestamp": "2026-08-07T18:37:42Z",
          "tree_id": "f0dea4a7ef02333685928b9a00b98250233abfdd",
          "url": "https://github.com/open-telemetry/otel-arrow/commit/09793c718a89e7c3a34f4c9238a890a33834acd4"
        },
        "date": 1786132485481,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": false,
          "id": "ee801c079fe8c7e6745121e6633175520d74e16d",
          "message": "feat(admin): add debug endpoint to retrieve CPU profile as pprof format from admin server (#3693)\n\n# Change Summary\n\n<!--Replace with a brief summary of the change in this PR-->\n\nSimilar to what was done in #3497, this PR adds an endpoint that can\ndumb a CPU profile in pprof format.\n\n```\ncurl -XGET \"http://localhost:8080/api/v1/debug/pprof/profile?seconds=10\"\n```\n\n## What issue does this PR close?\n\n<!--We highly recommend correlation of every PR to an issue-->\n\n* Closes #3692 \n\n## How are these changes tested?\n\nmanually\n\n## Are there any user-facing changes?\n\nYes - new endpoint in admin server\n\n <!-- If yes, provide further info below -->\n\n### Changelog\n\n<!--\nUser-facing changes need a .chloggen/*.yaml entry. Copy the\nTEMPLATE.yaml\nin go/.chloggen/ or rust/otap-dataflow/.chloggen/ and fill in the\nfields.\nIf not required, include `chore` in the PR title.\n-->\n\n* [x] Added a `.chloggen/*.yaml` entry\n* [ ] This PR is a `chore` (indicated in title)\n* [ ] This is a documentation-only PR.",
          "timestamp": "2026-08-07T19:52:12Z",
          "tree_id": "04398e8375a44336ed8ac98dec456ae5388c0dc5",
          "url": "https://github.com/open-telemetry/otel-arrow/commit/ee801c079fe8c7e6745121e6633175520d74e16d"
        },
        "date": 1786136383135,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": false,
          "id": "128fe63645ba251d4c2862b5327227be291dc994",
          "message": "feat(metrics): migrate log sampling processor to enum attributes (#3665)\n\nPart of #3530. Follow-up to #3664 and #3593.\n\nMigrates the `log_sampling_processor` telemetry to use the new standard\nenum attribute schema.\n\nChanges:\n- Dropped separate `log_signals_consumed` and `log_signals_dropped`\ncounters.\n- Replaced with a single `log_signals` metric dimensioned by\n`SamplingAction` (Consumed/Dropped/Error).\n- Switched to `MeasurementMetricSet` for reporting.\n- Updated docs and added a breaking changelog entry.\n\nTests are passing locally.",
          "timestamp": "2026-08-07T20:19:16Z",
          "tree_id": "c87bbe3a7b5f2eb3b8fa42cd7303a129eea73aec",
          "url": "https://github.com/open-telemetry/otel-arrow/commit/128fe63645ba251d4c2862b5327227be291dc994"
        },
        "date": 1786138139467,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "528fc6d9f7b39d4ecb2d9edb8f61d981732092de",
          "message": "fix(transform_processor): retain request metadata on split transform batches (#3694)\n\n# Change Summary\n\nWhen a query routed part of a batch, the transform processor built each\noutbound batch on `Context::default()`, dropping the inbound transport\nheaders and peer address.\n\nThis PR introduces a new helper, `Context::clone_detached`, which copies\nthe request metadata without the frames to be used by batch-splitting\nprocessors and updates the transform processor and partition processor\nto use it.\n\n## What issue does this PR close?\n\n* Closes #3501\n\n## How are these changes tested?\n\nNew unit tests.\n\n## Are there any user-facing changes?\n\nYes. Batches split by the transform processor keep the originating\nrequest's transport headers and peer address.\n\n### Changelog\n\n* [x] Added a `.chloggen/*.yaml` entry\n* [ ] This PR is a `chore` (indicated in title)\n* [ ] This is a documentation-only PR.\n\n---------\n\nCo-authored-by: albertlockett <a.lockett@f5.com>",
          "timestamp": "2026-08-07T20:24:48Z",
          "tree_id": "f3ec1bd2c55175d33c990f704a31f6a20d0865a7",
          "url": "https://github.com/open-telemetry/otel-arrow/commit/528fc6d9f7b39d4ecb2d9edb8f61d981732092de"
        },
        "date": 1786139409556,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": false,
          "id": "8358596d4311cd614f9742c59667806226a1d19a",
          "message": "chore(deps): update geneva-uploader digest to 24d1f73 (#3700)\n\nThis PR contains the following updates:\n\n| Package | Type | Update | Change |\n|---|---|---|---|\n| geneva-uploader | workspace.dependencies | digest | `75a2b0a` →\n`24d1f73` |\n\n---\n\n### Configuration\n\n📅 **Schedule**: (UTC)\n\n- Branch creation\n  - \"before 8am on Monday\"\n- Automerge\n  - At any time (no schedule defined)\n\n🚦 **Automerge**: Disabled by config. Please merge this manually once you\nare satisfied.\n\n♻ **Rebasing**: Whenever PR becomes conflicted, or you tick the\nrebase/retry checkbox.\n\n🔕 **Ignore**: Close this PR and you won't be reminded about this update\nagain.\n\n---\n\n- [ ] <!-- rebase-check -->If you want to rebase/retry this PR, check\nthis box\n\n---\n\nThis PR was generated by [Mend Renovate](https://mend.io/renovate/).\nView the [repository job\nlog](https://developer.mend.io/github/open-telemetry/otel-arrow).\n\n<!--renovate-debug:eyJjcmVhdGVkSW5WZXIiOiI0NC4xMi4wIiwidXBkYXRlZEluVmVyIjoiNDQuMTIuMCIsInRhcmdldEJyYW5jaCI6Im1haW4iLCJsYWJlbHMiOlsiZGVwZW5kZW5jaWVzIl19-->\n\nCo-authored-by: renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>\nCo-authored-by: albertlockett <a.lockett@f5.com>",
          "timestamp": "2026-08-10T16:27:06Z",
          "tree_id": "e9546cac36c8a2c6cf47a411b629a488dba6c2dc",
          "url": "https://github.com/open-telemetry/otel-arrow/commit/8358596d4311cd614f9742c59667806226a1d19a"
        },
        "date": 1786390661369,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "url": "https://github.com/open-telemetry/otel-arrow/commit/f507031c5004de0c6269d0f8522b4e5f8821d48a"
        },
        "date": 1786391962700,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "329c784db3c26976a559576f85cc0b1c8e6fa1e8",
          "message": "chore(deps): update azure sdk crates to d780f32 (#3699)\n\nThis PR contains the following updates:\n\n| Package | Type | Update | Change |\n|---|---|---|---|\n| azure_core | workspace.dependencies | digest | `606bf94` → `d780f32` |\n| azure_identity | workspace.dependencies | digest | `606bf94` →\n`d780f32` |\n\n---\n\n### Configuration\n\n📅 **Schedule**: (UTC)\n\n- Branch creation\n  - \"before 8am on Monday\"\n- Automerge\n  - At any time (no schedule defined)\n\n🚦 **Automerge**: Disabled by config. Please merge this manually once you\nare satisfied.\n\n♻ **Rebasing**: Whenever PR becomes conflicted, or you tick the\nrebase/retry checkbox.\n\n🔕 **Ignore**: Close this PR and you won't be reminded about these\nupdates again.\n\n---\n\n- [ ] <!-- rebase-check -->If you want to rebase/retry this PR, check\nthis box\n\n---\n\nThis PR was generated by [Mend Renovate](https://mend.io/renovate/).\nView the [repository job\nlog](https://developer.mend.io/github/open-telemetry/otel-arrow).\n\n<!--renovate-debug:eyJjcmVhdGVkSW5WZXIiOiI0NC4xMi4wIiwidXBkYXRlZEluVmVyIjoiNDQuMTIuMCIsInRhcmdldEJyYW5jaCI6Im1haW4iLCJsYWJlbHMiOlsiZGVwZW5kZW5jaWVzIl19-->\n\nCo-authored-by: renovate[bot] <29139614+renovate[bot]@users.noreply.github.com>\nCo-authored-by: albertlockett <a.lockett@f5.com>",
          "timestamp": "2026-08-10T22:05:09Z",
          "tree_id": "447ae0b242a4d90f5e036f77cdf1c0c23fecc0f6",
          "url": "https://github.com/open-telemetry/otel-arrow/commit/329c784db3c26976a559576f85cc0b1c8e6fa1e8"
        },
        "date": 1786404317447,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "f728b69b9b2fea8c2ceafe9137fb24a36d3a767b",
          "message": "chore: [query-engine] Add lifetime decoration to ArrayValue & MapValue get_items APIs (#3681)\n\n# Changes\n\n* Replace custom traits\\structs on `ArrayValue` & `MapyValue`\n`get_item*` APIs with more vanilla `&mut dyn FnMut(...)` contracts\n* Decorate `Value` argument on `ArrayValue` & `MapyValue` `get_item*`\nAPIs with lifetime\n\n# Details\n\nThe decoration makes it possible to use these \"iterator\"-like APIs to\ncreate mutable versions of arrays & maps sourced from something\nimmutable (think static data provided in a query) with shallow cloning.\n\nExample usage:\n\n```rust\nimpl<'a> From<&'a (dyn ArrayValue + 'a)> for OwnedArrayValue<'a> {\n    fn from(value: &'a (dyn ArrayValue + 'a)) -> Self {\n        let mut array = OwnedArrayValue::with_capacity(value.len());\n\n        let values = array.get_values_mut();\n\n        value.get_items(&mut |_, value| {\n            values.push(value.into()); // With change \"value\" here is Value<'a> without changes it is Value<'_>\n            true\n        });\n\n        array\n    }\n}\n```\n\nWhat does RecordSet do? Deep clone.\n\n---------\n\nCo-authored-by: Utkarsh Umesan Pillai <66651184+utpilla@users.noreply.github.com>",
          "timestamp": "2026-08-11T20:13:05Z",
          "tree_id": "e7b92d519c5a1975c7d7178b9dbf29f3941534a6",
          "url": "https://github.com/open-telemetry/otel-arrow/commit/f728b69b9b2fea8c2ceafe9137fb24a36d3a767b"
        },
        "date": 1786483913501,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": false,
          "id": "7793d28e7abd63b8fc54265ecbe7f9423beb5592",
          "message": "chore: [query-engine] Refactor ArrayValueMut & MapValueMut retain APIs (#3727)\n\nRelates to #3681\n\n# Changes\n\n* Replace custom traits\\structs on `ArrayValueMut` & `MapValueMut`\n`retain` APIs with more vanilla `&mut dyn FnMut(...)` contracts\n\n# Details\n\nThis PR cleans up the mutable APIs with the same change done on #3681\nfor immutable APIs.",
          "timestamp": "2026-08-12T06:28:43Z",
          "tree_id": "f3a315319e439cb038d3f80cf9f32e3e09b15647",
          "url": "https://github.com/open-telemetry/otel-arrow/commit/7793d28e7abd63b8fc54265ecbe7f9423beb5592"
        },
        "date": 1786520871336,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": false,
          "id": "60a459e40cfaa894ca4e54b62d43bdb76fe2a5ea",
          "message": "feat(metrics): improve channel telemetry with enum attributes (#3734)\n\n# Change Summary\n\nRefactors internal channel telemetry while preserving the\n`channel.sender.messages` and `channel.receiver.messages` metric sets.\n\nThe change introduces enum-based `channel.kind`, `channel.mode`,\n`channel.type`, and `channel.impl` attributes, improves channel metric\nsemantics and lifecycle reporting, and updates the admin UI to consume\nthe revised telemetry.\n\n## What issue does this PR close?\n\n* Related #3530\n\n## How are these changes tested?\n\n* `cargo xtask check`\n* Admin UI JavaScript tests\n\n## Are there any user-facing changes?\n\nYes. The admin UI now presents the revised channel telemetry, and\nexported internal channel metrics use stable enum-based attribute\nvalues.\n\n### Changelog\n\n* [x] Added a `.chloggen/*.yaml` entry\n* [ ] This PR is a `chore` (indicated in title)\n* [ ] This is a documentation-only PR.",
          "timestamp": "2026-08-12T21:36:11Z",
          "tree_id": "964218b2efcb35bcf5ea4ac3b92abba5b9b0412f",
          "url": "https://github.com/open-telemetry/otel-arrow/commit/60a459e40cfaa894ca4e54b62d43bdb76fe2a5ea"
        },
        "date": 1786575680078,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": false,
          "id": "2f68e264fd4abc62c67a2491c40f5bafc99318b1",
          "message": "chore: [query-engine] Use type aliasing to improve code quality in iterator APIs (#3736)\n\nRelates to #3681\nRelates to #3727\n\nFollow-up for\nhttps://github.com/open-telemetry/otel-arrow/pull/3727#discussion_r3764073226\n\n# Changes\n\n* Implement suggestion from @utpilla to improve code quality",
          "timestamp": "2026-08-12T23:09:01Z",
          "tree_id": "67c2f6f0483db50593b5b7b70d1487c1d8bda52e",
          "url": "https://github.com/open-telemetry/otel-arrow/commit/2f68e264fd4abc62c67a2491c40f5bafc99318b1"
        },
        "date": 1786579879846,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "id": "51377d0b813bb31635b2fb6b3de51552c6d39d94",
          "message": "Optimize OTAP log transformation in the ClickHouse exporter (#3711)\n\n# Change Summary\n\nOptimizes the ClickHouse exporter transformation path for canonical OTAP\nlog batches.\n\nThe exporter now uses a specialized, shape-preserving transformer that\nproduces the same ClickHouse schema and values as the existing generic\ntransformation pipeline while avoiding its general-purpose overhead.\n\nUnsupported OTAP layouts automatically fall back to the existing generic\ntransformer. OTLP logs, traces, and other payloads continue to use the\ngeneric path.\n\nThis PR is stacked on #3709.\n\n## Performance impact\n\nThe change was benchmarked against #3709 using:\n\n- 8,192-log batches\n- synchronous ClickHouse inserts\n- `max_in_flight: 10`\n- one df_engine core\n- six ClickHouse cores\n- twelve traffic-generator cores\n- ClickHouse 25.6\n- three 60-second repetitions per scenario\n\nMedian results for canonical DFE OTAP logs:\n\n| Metric | #3709 baseline | This change | Impact |\n| --- | --- | --- | --- |\n| Written throughput at maximum load | 682,597 logs/s | 885,655 logs/s |\n+29.7% / 1.30x |\n| DFE CPU at approximately 100,000 logs/s | 28.46% | 20.72% | -27.2% |\n\nWritten throughput at the fixed offered load remained approximately\n100,000 logs/s, as expected.\n\nThese results indicate that canonical OTAP log workloads can gain\napproximately 30% maximum throughput while using approximately 27% less\nDFE CPU at 100,000 logs/s. Actual gains depend on the input layout,\nworkload, and ClickHouse capacity. Inputs that do not match the\ncanonical layout use the generic fallback path.\n\n## What issue does this PR close?\n\n- Related to #3512\n- Implements the OTAP transformation optimization identified by the\nClickHouse exporter benchmarks in #3512\n\n## How are these changes tested?\n\nAutomated tests verify:\n\n- exact output parity between the specialized and generic transformers\n- logs with complete and omitted attribute sets\n- multiple resources and scopes with mixed content\n- service-name extraction, ID encoding, body conversion, and attribute\nmaps\n- automatic fallback when the canonical logs payload is unavailable\n- dictionary-encoded attribute parent IDs\n- null, missing, scalar, map, and slice attribute values\n- independent specialized-path and fallback telemetry counters\n\n## Are there any user-facing changes?\n\nYes. Canonical OTAP log batches are transformed more efficiently before\ninsertion into ClickHouse.\n\nThere is no new configuration and no expected change to the generated\nClickHouse schema or values. Unsupported input layouts automatically use\nthe existing generic transformer.\n\n### Changelog\n\n- [X] Added a `.chloggen/*.yaml` entry\n- [ ] This PR is a chore (indicated in title)\n- [ ] This is a documentation-only PR.",
          "timestamp": "2026-08-12T23:42:56Z",
          "url": "https://github.com/open-telemetry/otel-arrow/commit/51377d0b813bb31635b2fb6b3de51552c6d39d94"
        },
        "date": 1786581260955,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "message": "Optimize OTAP log transformation in the ClickHouse exporter (#3711)\n\n# Change Summary\n\nOptimizes the ClickHouse exporter transformation path for canonical OTAP\nlog batches.\n\nThe exporter now uses a specialized, shape-preserving transformer that\nproduces the same ClickHouse schema and values as the existing generic\ntransformation pipeline while avoiding its general-purpose overhead.\n\nUnsupported OTAP layouts automatically fall back to the existing generic\ntransformer. OTLP logs, traces, and other payloads continue to use the\ngeneric path.\n\nThis PR is stacked on #3709.\n\n## Performance impact\n\nThe change was benchmarked against #3709 using:\n\n- 8,192-log batches\n- synchronous ClickHouse inserts\n- `max_in_flight: 10`\n- one df_engine core\n- six ClickHouse cores\n- twelve traffic-generator cores\n- ClickHouse 25.6\n- three 60-second repetitions per scenario\n\nMedian results for canonical DFE OTAP logs:\n\n| Metric | #3709 baseline | This change | Impact |\n| --- | --- | --- | --- |\n| Written throughput at maximum load | 682,597 logs/s | 885,655 logs/s |\n+29.7% / 1.30x |\n| DFE CPU at approximately 100,000 logs/s | 28.46% | 20.72% | -27.2% |\n\nWritten throughput at the fixed offered load remained approximately\n100,000 logs/s, as expected.\n\nThese results indicate that canonical OTAP log workloads can gain\napproximately 30% maximum throughput while using approximately 27% less\nDFE CPU at 100,000 logs/s. Actual gains depend on the input layout,\nworkload, and ClickHouse capacity. Inputs that do not match the\ncanonical layout use the generic fallback path.\n\n## What issue does this PR close?\n\n- Related to #3512\n- Implements the OTAP transformation optimization identified by the\nClickHouse exporter benchmarks in #3512\n\n## How are these changes tested?\n\nAutomated tests verify:\n\n- exact output parity between the specialized and generic transformers\n- logs with complete and omitted attribute sets\n- multiple resources and scopes with mixed content\n- service-name extraction, ID encoding, body conversion, and attribute\nmaps\n- automatic fallback when the canonical logs payload is unavailable\n- dictionary-encoded attribute parent IDs\n- null, missing, scalar, map, and slice attribute values\n- independent specialized-path and fallback telemetry counters\n\n## Are there any user-facing changes?\n\nYes. Canonical OTAP log batches are transformed more efficiently before\ninsertion into ClickHouse.\n\nThere is no new configuration and no expected change to the generated\nClickHouse schema or values. Unsupported input layouts automatically use\nthe existing generic transformer.\n\n### Changelog\n\n- [X] Added a `.chloggen/*.yaml` entry\n- [ ] This PR is a chore (indicated in title)\n- [ ] This is a documentation-only PR.",
          "timestamp": "2026-08-12T23:42:56Z",
          "tree_id": "db82ef6dd55de99a494c9239e9929d7e4b919167",
          "url": "https://github.com/open-telemetry/otel-arrow/commit/51377d0b813bb31635b2fb6b3de51552c6d39d94"
        },
        "date": 1786582537262,
        "tool": "customSmallerIsBetter",
      ...
      },
      {
        "commit": {
          ...
          "url": "https://github.com/open-telemetry/otel-arrow/commit/db03ee3e25ee8529e631fe76af3bbb302e8f148d"
        },
        "date": 1786584106507,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "tree_id": "bba7fa252b4653e0317c0b6204e2182988187e1e",
      ...
      },
      {
        "commit": {
          ...
          "url": "https://github.com/open-telemetry/otel-arrow/commit/251ce3f2cb0a5116798723981474505f32271e4d"
        },
        "date": 1786644140993,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "tree_id": "53054c8771b7fabd09fa7271016c9fbaff2b1173",
      ...
      },
      {
        "commit": {
          ...
          "url": "https://github.com/open-telemetry/otel-arrow/commit/690356560898fa361f547f4c8a800457c9f7f11e"
        },
        "date": 1786691330002,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "url": "https://github.com/open-telemetry/otel-arrow/commit/ae289471953be1e885fb1c4425d01d59f5370491"
        },
        "date": 1786735241234,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "b5fd9f2e560224a668527c3f257388adbe10e991",
          "message": "chore(release) Prepare Release v0.51.0 (#3770)\n\n## Release v0.51.0\n\nThis PR prepares the repository for release v0.51.0.\n\n### Changes included:\n- Rendered pending chloggen entries into `go/CHANGELOG.md` and\n`rust/otap-dataflow/CHANGELOG.md`\n- Bumped `rust/otap-dataflow/Cargo.toml` (workspace + root package)\n\n## What's Changed (Go :hamster:)\n\n### :bulb: Enhancements :bulb:\n\n- `dependencies`: Upgrade various Go dependencies.\n([#3545](https://github.com/open-telemetry/otel-arrow/issues/3545),\n[#3599](https://github.com/open-telemetry/otel-arrow/issues/3599),\n[#3643](https://github.com/open-telemetry/otel-arrow/issues/3643))\n\n### :toolbox: Bug fixes :toolbox:\n\n- `pkg/otel/arrow`: Return an error instead of panicking when a batch\ncontains more than 65535 records.\n([#1883](https://github.com/open-telemetry/otel-arrow/issues/1883))\n\n## What's Changed (Rust :crab:)\n\n### :stop_sign: Breaking changes :stop_sign:\n\n- `engine`: Add the `BearerTokenAuthorizer` capability and move\nbearer-token capabilities to `capability::auth`.\n([#3494](https://github.com/open-telemetry/otel-arrow/issues/3494))\n\n- `engine`: Replace flow `signals.incoming`, `signals.outgoing`, and\n`signals.dropped` metrics with `consumed.items`, `produced.items`, and\n`dropped.items` counters.\n([#3300](https://github.com/open-telemetry/otel-arrow/issues/3300))\n\n- `engine`: Self-telemetry resource attributes are now produced by\nconfigurable ResourceDetectors (`engine.telemetry.detectors`), replacing\nthe bespoke host/container/instance detection.\n([#3177](https://github.com/open-telemetry/otel-arrow/issues/3177))\n\n- `engine`: Add NUMA-aware topology discovery, controller-owned\nnon-overlapping core_count placement, and listener-group placement\nmetadata.\n([#1837](https://github.com/open-telemetry/otel-arrow/issues/1837))\n\n- `engine`: Add `signal` and `outcome` attributes to node message\nmetrics and add opt-in item counters.\n([#3300](https://github.com/open-telemetry/otel-arrow/issues/3300),\n[#3436](https://github.com/open-telemetry/otel-arrow/issues/3436))\n\n- `engine`: Replace channel counters with bounded message outcome, send\nfailure classification, and queue depth metrics.\n([#3530](https://github.com/open-telemetry/otel-arrow/issues/3530))\n\n- `observability`: Invalid internal log-level settings now cause startup\nor reconciliation to fail.\n([#3387](https://github.com/open-telemetry/otel-arrow/issues/3387))\n- `observability`: Remove the direct OpenTelemetry client SDK metrics\npath and Prometheus pull export.\n([#2409](https://github.com/open-telemetry/otel-arrow/issues/2409))\n\n- `pipeline`: Migrate filter_processor metrics to use enum attributes.\n([#3530](https://github.com/open-telemetry/otel-arrow/issues/3530))\n\n- `pipeline`: Replace durable buffer processor metric series with\nbounded metric sets for item flow, bundle outcomes, and loss reasons.\n([#3300](https://github.com/open-telemetry/otel-arrow/issues/3300))\n\n- `pipeline`: Geneva PKCS#12 certificate authentication is now disabled\nby default and requires an explicit build feature.\n([#3408](https://github.com/open-telemetry/otel-arrow/issues/3408))\n\n- `pipeline`: Remove debug processor request and primary item metrics,\nretaining only event and link metrics under `processor.debug`.\n([#3432](https://github.com/open-telemetry/otel-arrow/issues/3432),\n[#3649](https://github.com/open-telemetry/otel-arrow/issues/3649))\n\n- `pipeline`: Migrate kafka exporter metrics to use signal attribute\nenums instead of separate signal-specific counters\n([#3530](https://github.com/open-telemetry/otel-arrow/issues/3530))\n\n- `pipeline`: Refactored log sampling metrics to use standard\n`processor.log_sampling.dropped.items` metric instead of separate\nconsumed/dropped counters.\n([#3530](https://github.com/open-telemetry/otel-arrow/issues/3530))\n\n- `pipeline`: Replace individual content_router metrics (e.g.,\nsignals_routed, signals_nacked) with new metric set partitioned by\n`outcome` and `reason` attributes\n([#3530](https://github.com/open-telemetry/otel-arrow/issues/3530))\n\n- `pipeline`: Replace shared PData exporter outcome and OTLP receiver\nmetric series with bounded metric sets.\n([#3300](https://github.com/open-telemetry/otel-arrow/issues/3300))\n\n- `pipeline`: Consolidate durable buffer retention loss as delta\ncounters under one metric family.\n([#3397](https://github.com/open-telemetry/otel-arrow/issues/3397))\n\n- `pipeline`: Replace the partition processor's separate success and\nfailure counters with `processor.partition.operations`, partitioned by\n`outcome`, using unit `{operation}`.\n([#3530](https://github.com/open-telemetry/otel-arrow/issues/3530))\n\n- `pipeline`: Remove the batch processor's per-signal\n`consumed.batches.*` and `produced.batches.*` counters.\n([#3530](https://github.com/open-telemetry/otel-arrow/issues/3530))\n\n- `pipeline`: Remove the perf exporter counters\n`exporter.perf.pdata.logs`, `exporter.perf.pdata.spans`,\n`exporter.perf.pdata.metrics`, and\n`exporter.perf.pdata.invalid_batches`.\n([#3530](https://github.com/open-telemetry/otel-arrow/issues/3530))\n\n- `pipeline`: Replace individual attributes_processor metrics (e.g.,\ndeleted_entries, inserted_entries, domains_signal) with new metric sets\npartitioned by `action` and `domain`\"\n([#3593](https://github.com/open-telemetry/otel-arrow/issues/3593),\n[#3530](https://github.com/open-telemetry/otel-arrow/issues/3530))\n\n- `pipeline`: Replace Azure Monitor exporter completion, HTTP,\nstate-mapping, and heartbeat metric series with bounded metric sets.\n([#3300](https://github.com/open-telemetry/otel-arrow/issues/3300))\n\n- `pipeline`: Replace retry processor per-signal item-outcome and\nretry-attempt counters with engine node metrics and bounded scheduled,\nrecovered, and terminated metrics.\n([#3530](https://github.com/open-telemetry/otel-arrow/issues/3530))\n\n- `pipeline`: Refactor signal_type_router telemetry to use standard\noutcome-and-reason enum attributes instead of discrete named metrics.\n([#3716](https://github.com/open-telemetry/otel-arrow/issues/3716))\n\n- `pipeline`: Replace transform processor message counters with bounded\noperation outcome and failure classification metrics.\n([#3530](https://github.com/open-telemetry/otel-arrow/issues/3530))\n\n### :rocket: New components :rocket:\n\n- `pipeline`: Add the `oauth2_client_auth` extension, a\n`BearerTokenProvider` backed by the OAuth 2.0 client-credentials and\nJWT-bearer grants.\n([#3479](https://github.com/open-telemetry/otel-arrow/issues/3479))\n\n- `pipeline`: Add the experimental wasm-host processor plugin runtime\nwith a host-kernel WASM processor node\n([#2973](https://github.com/open-telemetry/otel-arrow/issues/2973),\n[#3227](https://github.com/open-telemetry/otel-arrow/issues/3227))\n\n### :bulb: Enhancements :bulb:\n\n- `dependencies`: Upgrade various Rust dependencies.\n([#3526](https://github.com/open-telemetry/otel-arrow/issues/3526),\n[#3536](https://github.com/open-telemetry/otel-arrow/issues/3536),\n[#3546](https://github.com/open-telemetry/otel-arrow/issues/3546),\n[#3570](https://github.com/open-telemetry/otel-arrow/issues/3570),\n[#3592](https://github.com/open-telemetry/otel-arrow/issues/3592),\n[#3601](https://github.com/open-telemetry/otel-arrow/issues/3601),\n[#3629](https://github.com/open-telemetry/otel-arrow/issues/3629),\n[#3633](https://github.com/open-telemetry/otel-arrow/issues/3633),\n[#3642](https://github.com/open-telemetry/otel-arrow/issues/3642),\n[#3699](https://github.com/open-telemetry/otel-arrow/issues/3699),\n[#3700](https://github.com/open-telemetry/otel-arrow/issues/3700),\n[#3702](https://github.com/open-telemetry/otel-arrow/issues/3702),\n[#3703](https://github.com/open-telemetry/otel-arrow/issues/3703))\n- `engine`: Add the `#[component_inventory]` attribute macro and\n`inventory` module (RFC 0001, Phase 1)\n([#3435](https://github.com/open-telemetry/otel-arrow/issues/3435))\n\n- `engine`: Add the `AgentFedCredentialProvider` capability, which\nsupplies a bearer token and its vendor-defined routing attributes as one\natomically-published snapshot.\n([#3275](https://github.com/open-telemetry/otel-arrow/issues/3275))\n\n- `engine`: Add the `VendorBundle` capability so an agent-fed extension\ncan hand an opaque, vendor-defined attribute bag (a JSON object) to\ndata-path nodes.\n([#3477](https://github.com/open-telemetry/otel-arrow/issues/3477))\n\n- `engine`: Generalize `AuthorizedIdentity` into a scheme-agnostic\nclaims model: a `principal`, a `scheme` tag, and a `claims` map of\nsingle- or multi-valued `ClaimValue` keyed by name.\n([#3494](https://github.com/open-telemetry/otel-arrow/issues/3494))\n\n- `engine`: Add CPU profiling endpoint at `/api/v1/debug/pprof/profile`\nthat collects a CPU profile in pprof format.\n([#3692](https://github.com/open-telemetry/otel-arrow/issues/3692))\n- `engine`: Remove the unimplemented `processor_chain` node kind, which\nthe engine never supported and always rejected at build time.\n([#2556](https://github.com/open-telemetry/otel-arrow/issues/2556))\n\n- `engine`: Add component inventory annotations across engine components\nand non-factory categories (RFC 0001, Phase 2)\n([#3435](https://github.com/open-telemetry/otel-arrow/issues/3435))\n\n- `engine`: Add heap profiling endpoint at `/api/v1/debug/pprof/heap`\nthat dumps jemalloc heap allocations in pprof format.\n([#3660](https://github.com/open-telemetry/otel-arrow/issues/3660))\n- `engine`: Wire the broadcast `all` (consensus) Ack/Nack mode into the\ntopic engine\n([#2252](https://github.com/open-telemetry/otel-arrow/issues/2252))\n\n- `engine`: Default self-telemetry `service.name`/`service.version` now\ncome from build info (binary name and version) instead of\n`unknown_service`, seeded beneath config and the `OTEL_*` env detectors.\n([#3177](https://github.com/open-telemetry/otel-arrow/issues/3177))\n\n- `engine`: Hardened security response headers (`X-Content-Type-Options:\nnosniff`, `X-Frame-Options: DENY`, `Referrer-Policy: no-referrer`,\n`Cache-Control: no-store, no-cache, must-revalidate`) are now applied to\nall `/api/v1/*` API endpoints via an Axum `map_response` middleware\nlayer. Previously these headers were only set on static UI routes in\n`dashboard.rs`.\n([#3445](https://github.com/open-telemetry/otel-arrow/issues/3445))\n- `observability`: Require the `scope` keyword on scope `attribute_set`\ndeclarations and remove support for named measurement attribute sets.\n([#3513](https://github.com/open-telemetry/otel-arrow/issues/3513))\n\n- `observability`: OpenTelemetry exponential histogram in Metrics ITS\n([#2428](https://github.com/open-telemetry/otel-arrow/issues/2428),\n[#2458](https://github.com/open-telemetry/otel-arrow/issues/2458))\n\n- `observability`: Apply reconciled internal log-level changes without\nrestarting the engine.\n([#3387](https://github.com/open-telemetry/otel-arrow/issues/3387))\n- `pipeline`: Run up to 10 ClickHouse inserts concurrently by default\nand allow max_in_flight to tune the limit.\n([#3512](https://github.com/open-telemetry/otel-arrow/issues/3512))\n\n- `pipeline`: OTLP HTTP exporter can consume the `bearer_token_provider`\ncapability to inject a refreshed `Authorization: Bearer` header.\n([#3356](https://github.com/open-telemetry/otel-arrow/issues/3356))\n\n- `pipeline`: ETW receiver now accepts provider names in addition to\nGUIDs.\n([#2783](https://github.com/open-telemetry/otel-arrow/issues/2783))\n- `pipeline`: Report persisted bytes removed by durable-buffer runtime\nretention.\n([#2884](https://github.com/open-telemetry/otel-arrow/issues/2884))\n- `pipeline`: Geneva exporter now supports separate, configurable event\nnames for logs and spans via `logs.default_event_name` and\n`spans.default_event_name` to control which Geneva tables telemetry\nroutes to.\n([#3600](https://github.com/open-telemetry/otel-arrow/issues/3600))\n\n- `pipeline`: Geneva exporter can route logs and spans to different\ntables based on an attribute value via `event_name_mapping`, using\nresource, scope, or record/span attributes (and `event_name` for logs).\n([#3600](https://github.com/open-telemetry/otel-arrow/issues/3600))\n\n- `pipeline`: Geneva exporter accepts an optional `obo` configuration to\nupload telemetry on behalf of multiple customer identities, keyed by\nevent/table name.\n([#3754](https://github.com/open-telemetry/otel-arrow/issues/3754))\n\n- `pipeline`: Switch the Geneva exporter TLS backend from\nnative-tls/OpenSSL to rustls\n([#3408](https://github.com/open-telemetry/otel-arrow/issues/3408))\n\n- `pipeline`: Add consumer-group observability metrics and structured\nlogs to the Kafka receiver.\n([#3535](https://github.com/open-telemetry/otel-arrow/issues/3535))\n\n- `pipeline`: Added an in-process Kafka test suite for the contrib-nodes\nKafka receiver and exporter. Built on librdkafka's mock cluster, it\nneeds no external broker and provides a test cluster with declarative\ntopics, test producers and consumers, consumer-group rebalancing, broker\nfault injection, read-only broker/group inspection, node harnesses that\nwire the receiver/exporter against the mock broker, and fluent record\nassertions.\n([#3540](https://github.com/open-telemetry/otel-arrow/issues/3540))\n- `pipeline`: Resolve resource policy members independently across\nconfiguration scopes.\n([#3529](https://github.com/open-telemetry/otel-arrow/issues/3529))\n- `pipeline`: Add pretty and record_json output formats to the console\nexporter, including newline-delimited structured log records and\nseparate internal telemetry log and metric example configurations.\n([#3611](https://github.com/open-telemetry/otel-arrow/issues/3611))\n- `pipeline`: The OTLP gRPC exporter can now authenticate with a\nrefreshed OAuth bearer token by binding the `bearer_token_provider`\ncapability.\n([#3479](https://github.com/open-telemetry/otel-arrow/issues/3479))\n\n- `pipeline`: Add bounded outcome and error type metrics to the console\nexporter, with actionable warnings for unsupported signals.\n([#3300](https://github.com/open-telemetry/otel-arrow/issues/3300))\n- `pipeline`: Reduce CPU used to transform OTAP logs in the ClickHouse\nexporter.\n([#3512](https://github.com/open-telemetry/otel-arrow/issues/3512))\n\n- `pipeline`: Add pressure-aware rate throttling for OTLP and Syslog\nreceivers.\n([#3484](https://github.com/open-telemetry/otel-arrow/issues/3484))\n- `pipeline`: Let the Geneva exporter use an atomic\n`AgentFedCredentialProvider` snapshot instead of driving its own\nconfig-service handshake.\n([#3275](https://github.com/open-telemetry/otel-arrow/issues/3275))\n\n- `pipeline`: Auto-inject `TimeGenerated` from the log record event time\nwhen no Azure Monitor mapping targets it. An explicit mapping or\npassthrough attribute takes precedence.\n([#3407](https://github.com/open-telemetry/otel-arrow/issues/3407))\n\n- `pipeline`: Add an Azure Monitor attribute passthrough mode that emits\neach log-record attribute as a top-level column.\n([#3407](https://github.com/open-telemetry/otel-arrow/issues/3407))\n\n- `pipeline`: Add export byte counter to `azure_monitor_exporter`\npartitioned by `signal` and `outcome`.\n([#3519](https://github.com/open-telemetry/otel-arrow/issues/3519))\n- `pipeline`: Add support for Arc-connected servers to\nazure_identity_auth extension\n([#3549](https://github.com/open-telemetry/otel-arrow/issues/3549))\n- `pipeline`: Add pressure-aware messages-per-second rate limiting for\nthe Syslog / CEF receiver.\n([#3484](https://github.com/open-telemetry/otel-arrow/issues/3484))\n- `query-engine`: Add support for concrete metric types in OPL type\nhierarchy\n([#3721](https://github.com/open-telemetry/otel-arrow/issues/3721))\n\n### :toolbox: Bug fixes :toolbox:\n\n- `engine`: Include configured custom identity attributes in channel\nnode metrics.\n([#3645](https://github.com/open-telemetry/otel-arrow/issues/3645))\n- `engine`: Reject invalid node rate limiter bindings during\nconfiguration-only validation.\n([#3529](https://github.com/open-telemetry/otel-arrow/issues/3529))\n- `engine`: Automatically recover failed regular pipeline cores with\nbounded per-core restart policies, and fail the process when recovery is\nexhausted.\n([#3561](https://github.com/open-telemetry/otel-arrow/issues/3561),\n[#3567](https://github.com/open-telemetry/otel-arrow/issues/3567))\n- `engine`: Size the default memory-limiter hysteresis as\n`min(hard_limit - soft_limit, soft_limit / 10)` so an omitted hysteresis\nrecovers from Soft once usage falls modestly below the soft limit.\n([#2425](https://github.com/open-telemetry/otel-arrow/issues/2425))\n\n- `engine`: Report pending processor and flow metrics before returning a\nprocessing error.\n([#3632](https://github.com/open-telemetry/otel-arrow/issues/3632))\n\n- `observability`: Expose metric data point attributes from the admin\nmetrics JSON endpoint.\n([#3300](https://github.com/open-telemetry/otel-arrow/issues/3300))\n- `pdata`: Prevent metrics encoding panics from missing resources or\nmisaligned scope schema rows.\n([#3565](https://github.com/open-telemetry/otel-arrow/issues/3565))\n- `pdata`: Best-effort split of a single oversize OTLP resource entry\nwhen batching by bytes, descending to scopes then individual records; an\nindivisible unit may still exceed max_size.\n([#3661](https://github.com/open-telemetry/otel-arrow/issues/3661))\n\n- `pdata`: Harden OTLP proto byte-view field decoding against malformed\ninput so truncated LEN and fixed-width fields are treated as absent\ninstead of producing out-of-range reads or hanging.\n([#3661](https://github.com/open-telemetry/otel-arrow/issues/3661))\n\n- `pdata`: Prevent dictionary key overflow from panicking during OTAP\nbatch concatenation.\n([#3566](https://github.com/open-telemetry/otel-arrow/issues/3566))\n- `pdata`: fixes panic proto decoding `common::KeyValue` with invalid\nfield lengths\n([#3672](https://github.com/open-telemetry/otel-arrow/issues/3672))\n- `pipeline`: Bound journald filtered follow waits so unrelated journal\nactivity cannot indefinitely delay batch flushes or shutdown.\n([#3399](https://github.com/open-telemetry/otel-arrow/issues/3399))\n- `pipeline`: kafka_receiver: bound the shutdown drain of an in-flight\nconsumer-lag worker by the tighter of the worker's own deadline and the\npipeline shutdown deadline, and signal cooperative cancellation to the\nworker.\n ([#3616](https://github.com/open-telemetry/otel-arrow/issues/3616))\n\n- `pipeline`: kafka_receiver: fix committed-offset rollback across\nconsumer-group rebalances when a partition is revoked and reassigned to\nthe same consumer. The offset tracker now resets a partition's\npending/high-water-mark state on an ownership generation change, and the\nstale-ack guard drops feedback whose generation is older than the\npartition's currently-assigned generation (not only the tracked\ngeneration).\n ([#3505](https://github.com/open-telemetry/otel-arrow/issues/3505))\n\n- `pipeline`: kafka_receiver: reprocess messages redelivered under a\nnewer consumer-group generation instead of dropping them as duplicates,\nand bound the consumer close at shutdown to the shutdown deadline.\n ([#3505](https://github.com/open-telemetry/otel-arrow/issues/3505))\n\n- `pipeline`: WASM processor filtering now preserves OTAP parent-child\nbatch relationships instead of filtering only the root batch.\n([#3478](https://github.com/open-telemetry/otel-arrow/issues/3478))\n- `pipeline`: Preserve bytes, arrays, maps, and empty values that cannot\nbe condensed by the Condense Attributes processor.\n([#1694](https://github.com/open-telemetry/otel-arrow/issues/1694))\n- `pipeline`: Attribute Ack/Nack ownership of byte-split OTLP fragments\nto the originating input so no fragment is untracked, and bound split\nfan-out with fragment and byte-amplification budgets.\n([#3661](https://github.com/open-telemetry/otel-arrow/issues/3661))\n\n- `pipeline`: Retain transport headers and peer address on outbound\nbatches when the transform processor splits a batch\n([#3501](https://github.com/open-telemetry/otel-arrow/issues/3501))\n\n- `pipeline`: Reject unsupported live changes to the process-wide memory\nlimiter.\n([#3529](https://github.com/open-telemetry/otel-arrow/issues/3529))\n- `pipeline`: Clarify Azure Monitor exporter metric descriptions for\ncompleted export attempts.\n([#3625](https://github.com/open-telemetry/otel-arrow/issues/3625))\n- `query-engine`: Parse standard RFC 822 named time zones in date-time\nexpressions.\n([#2047](https://github.com/open-telemetry/otel-arrow/issues/2047))\n- `query-engine`: Prevent scalar predicate results from terminating\nattribute filters.\n([#3605](https://github.com/open-telemetry/otel-arrow/issues/3605))\n- `query-engine`: Fix panics parsing OPL empty query and escape\nsequences\n([#3658](https://github.com/open-telemetry/otel-arrow/issues/3658))\n\n### Checklist:\n- [ ] Verify both CHANGELOG.md files render the expected entries\n- [ ] Verify Rust crate versions updated\n- [ ] Confirm all tests pass\n- [ ] Ready to merge and tag release\n\nAfter merging this PR, run the **Push Release** workflow to create git\ntags and publish the GitHub release.\n\nCo-authored-by: otelbot-arrow[bot] <289780372+otelbot-arrow[bot]@users.noreply.github.com>",
          "timestamp": "2026-08-14T19:48:05Z",
          "tree_id": "218faca83e49a032ffa590ba558bb4d88aacc2c4",
          "url": "https://github.com/open-telemetry/otel-arrow/commit/b5fd9f2e560224a668527c3f257388adbe10e991"
        },
        "date": 1786741370486,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": false,
          "id": "8823959bd42a95044cc8c1f01b24884ea5d2dfa6",
          "message": "feat(opamp): accept YAML remote configuration (#3759)\n\nAccept YAML engine configuration from OpAMP servers in addition to JSON.\n\nSupport standard YAML media types and detect JSON or YAML when the\nconfig file omits its content type, as the opamp-go example server does.\nEffective configuration reporting remains canonical JSON.",
          "timestamp": "2026-08-14T21:13:10Z",
          "tree_id": "453cbd322297c399fad3a761baef7dcbda441d1d",
          "url": "https://github.com/open-telemetry/otel-arrow/commit/8823959bd42a95044cc8c1f01b24884ea5d2dfa6"
        },
        "date": 1786745658766,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": false,
          "id": "74ddd85ac2a225d9d807cf8e23cfba93eaf9f52b",
          "message": "docs(auth extensions): describe the design, not its delivery status (#3772)\n\n# Change Summary\n\nBoth auth extension design docs mixed design with work status, so they\nread as stale the moment something landed: a Draft status header,\n\"target\" crate and module, \"v1\" scoping, \"today\" comparisons against the\npre-extension code, a consumer section written as a refactor (\"is\nrefactored to\", \"are removed\", \"re-sourced\"), an integration described\nas planned that has since shipped, and open questions annotated with the\nPR that deferred them.\n\nState the design in the present tense throughout. Scope statements that\nwere phrased as \"v1 does X\" now say what the extension does; the problem\nstatements say what is impossible without a shared token source rather\nthan what the code looked like before; consumer sections describe the\nend state; and Open Questions and Future Work keep the design boundaries\nwithout the tracking references.\n\n## What issue does this PR close?\n\nn/a\n\n## How are these changes tested?\n\nn/a\n\n## Are there any user-facing changes?\n\nno\n\n### Changelog\n\n<!--\nUser-facing changes need a .chloggen/*.yaml entry. Copy the\nTEMPLATE.yaml\nin go/.chloggen/ or rust/otap-dataflow/.chloggen/ and fill in the\nfields.\nIf not required, include `chore` in the PR title.\n-->\n\n* [ ] Added a `.chloggen/*.yaml` entry\n* [ ] This PR is a `chore` (indicated in title)\n* [x] This is a documentation-only PR.",
          "timestamp": "2026-08-14T22:16:25Z",
          "tree_id": "48d663468c30303b7ba2d38c7f641474910c4b89",
          "url": "https://github.com/open-telemetry/otel-arrow/commit/74ddd85ac2a225d9d807cf8e23cfba93eaf9f52b"
        },
        "date": 1786750170185,
        "tool": "customSmallerIsBetter",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "url": "https://github.com/open-telemetry/otel-arrow/commit/ffdb34b098b94b09f0ee4a7b93ca8f2107d240a8"
        },
        "date": 1786751669230,
        "tool": "customSmallerIsBetter",
        "benches": [
