...
![Avg % of compressed size improvement of OTAP over OTLP (zstd compression)](img/average_improvement_heatmap.png)

For detailed Phase 1 benchmark results, see the [Phase 1 benchmarks](benchmarks-phase1.md) page.
