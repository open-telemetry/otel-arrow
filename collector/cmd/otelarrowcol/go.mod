...
require (
	...
	github.com/open-telemetry/otel-arrow/collector/receiver/filereceiver v0.20.0
...
replace github.com/open-telemetry/otel-arrow/collector/extension/memorylimiterextension => ../../../collector/extension/memorylimiterextension
