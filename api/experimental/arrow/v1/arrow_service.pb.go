...
// StatusCode carries certain known meanings in Arrow.  Values in the
type StatusCode int32

const (
	// OK indicates successful delivery
	StatusCode_OK StatusCode = 0
	// CANCELED indicates the server has received the first half of the stream
	// close sequence and is closing itself, considered not an error.
	StatusCode_CANCELED StatusCode = 1 // a.k.a. codes.Canceled
	// UNAVAILABLE indicates the consumer had a retryable error, e.g., a
	// downstream timeout.
	StatusCode_UNAVAILABLE StatusCode = 14 // a.k.a. codes.Unavailable
	// INVALID_ARGUMENT indicates the data could not be properly encoded
	// or decoded somehow (details in status message).  This is not retryable.
	StatusCode_INVALID_ARGUMENT StatusCode = 3 // a.k.a. codes.InvalidArgument
	// RESOURCE_EXHAUSTED indicates (for example) that the request was too large
	// after decompression for the receiver to process.  This may be retryable,
	// depending on retry settings.
	StatusCode_RESOURCE_EXHAUSTED StatusCode = 8 // a.k.a. codes.ResourceExhausted
)
...
type BatchArrowRecords struct {
	...
	// [mandatory] The uncompressed size of the batch.
...
func (x *BatchArrowRecords) GetUncompressedSize() uint64 {
	if x != nil {
...
var file_opentelemetry_proto_experimental_arrow_v1_arrow_service_proto_rawDesc = []byte{
	...
	0x6c, 0x2e, 0x61, 0x72, 0x72, 0x6f, 0x77, 0x2e, 0x76, 0x31, 0x22, 0xd5, 0x01, 0x0a, 0x11, 0x42,
	...
	,
	...
	0x61, 0x67, 0x65, 0x2a, 0xf9, 0x04, 0x0a, 0x10, 0x41, 0x72, 0x72, 0x6f, 0x77, 0x50, 0x61, 0x79,
	...
	0x50, 0x45, 0x5f, 0x41, 0x54, 0x54, 0x52, 0x53, 0x10, 0x02, 0x12, 0x16, 0x0a, 0x12, 0x55, 0x4e,
	...
	,
	...
	0x74, 0x75, 0x73, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x42, 0x83, 0x01, 0x0a, 0x2c, 0x69, 0x6f,
	0x2e, 0x6f, 0x70, 0x65, 0x6e, 0x74, 0x65, 0x6c, 0x65, 0x6d, 0x65, 0x74, 0x72, 0x79, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x65, 0x78, 0x70, 0x65, 0x72, 0x69, 0x6d, 0x65, 0x6e, 0x74, 0x61,
	...
	0x61, 0x72, 0x72, 0x6f, 0x77, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x65, 0x78, 0x70, 0x65, 0x72, 0x69,
