...
use arrow::array::{
    BinaryArray, BooleanArray, Float64Array, Int64Array, RecordBatch, StringArray, UInt8Array,
    UInt16Array,
};
use snafu::OptionExt;

use crate::arrays::{
    MaybeDictArrayAccessor, NullableArrayAccessor, get_bool_array_opt, get_f64_array_opt,
