...
pub mod logs {
    ...
    pub fn create_request_with_multiple_resources_and_scope() -> ExportLogsServiceRequest {
        ExportLogsServiceRequest::new(vec![
            ResourceLogs::build(
                Resource::build(vec![
                    KeyValue::new("attr1", AnyValue::new_string("a")),
                    KeyValue::new("attr1", AnyValue::new_string("a")),
                    KeyValue::new("id", AnyValue::new_string("1")),
                ])
                .finish(),
            )
            .scope_logs(vec![
                ScopeLogs::build(
                    // TODO scope name breaks test if is empty string?
                    InstrumentationScope::build("")
                        .attributes(vec![
                            KeyValue::new("attr1", AnyValue::new_string("a")),
                            KeyValue::new("attr1", AnyValue::new_string("a")),
                            KeyValue::new("attr1", AnyValue::new_string("b")),
                            KeyValue::new("id", AnyValue::new_string("1.a")),
                        ])
                        .finish(),
                )
                .log_records(vec![
                    LogRecord::build(TIMESTAMP, SeverityNumber::Info, EVENT_NAME)
                        .severity_text("INFO")
                        .body(AnyValue::new_string("Test log message 1".to_string()))
                        .attributes(vec![
                            KeyValue::new("attr1", AnyValue::new_string("a")),
                            KeyValue::new("attr1", AnyValue::new_string("a")),
                            KeyValue::new("attr1", AnyValue::new_string("b")),
                            KeyValue::new("id", AnyValue::new_string("1.a.i")),
                        ])
                        .trace_id((0u8..16u8).collect::<Vec<u8>>())
                        .span_id((0u8..8u8).collect::<Vec<u8>>())
                        .finish(),
                    LogRecord::build(TIMESTAMP, SeverityNumber::Info, EVENT_NAME)
                        .severity_text("INFO")
                        .body(AnyValue::new_string("Test log message 2".to_string()))
                        .attributes(vec![
                            KeyValue::new("attr1", AnyValue::new_string("a")),
                            KeyValue::new("attr1", AnyValue::new_string("b")),
                            KeyValue::new("attr1", AnyValue::new_string("c")),
                            KeyValue::new("id", AnyValue::new_string("1.a.ii")),
                        ])
                        .trace_id((0u8..16u8).collect::<Vec<u8>>())
                        .span_id((0u8..8u8).collect::<Vec<u8>>())
                        .finish(),
            ...
            ResourceLogs::build(
                Resource::build(vec![
                    KeyValue::new("attr1", AnyValue::new_string("a")),
                    KeyValue::new("attr1", AnyValue::new_string("c")),
                    KeyValue::new("id", AnyValue::new_string("2")),
                ])
                .finish(),
            )
            .scope_logs(vec![
                ScopeLogs::build(
                    ...
                    InstrumentationScope::build("")
                        .attributes(vec![
                            ...
                            KeyValue::new("attr1", AnyValue::new_string("b")),
                            KeyValue::new("attr1", AnyValue::new_string("b")),
                            KeyValue::new("id", AnyValue::new_string("2.a")),
                        ])
                        .finish(),
                )
                .log_records(vec![
                    LogRecord::build(TIMESTAMP, SeverityNumber::Info, EVENT_NAME)
                        .severity_text("INFO")
                        .body(AnyValue::new_string("Test log message 2.1".to_string()))
                        .attributes(vec![
                            KeyValue::new("attr1", AnyValue::new_string("a")),
                            KeyValue::new("attr1", AnyValue::new_string("a")),
                            KeyValue::new("attr1", AnyValue::new_string("b")),
                            KeyValue::new("id", AnyValue::new_string("2.a.i")),
                        ])
                        .trace_id((0u8..16u8).collect::<Vec<u8>>())
                        .span_id((0u8..8u8).collect::<Vec<u8>>())
                        .finish(),
                    LogRecord::build(TIMESTAMP, SeverityNumber::Info, EVENT_NAME)
                        ...
                        .attributes(vec![
                            ...
                            KeyValue::new("attr1", AnyValue::new_string("b")),
                            KeyValue::new("attr1", AnyValue::new_string("c")),
                            KeyValue::new("id", AnyValue::new_string("2.a.ii")),
                        ])
                        .trace_id((0u8..16u8).collect::<Vec<u8>>())
                        .span_id((0u8..8u8).collect::<Vec<u8>>())
                        .finish(),
