...
/// The rule name is expected to be either "true_literal" or "false_literal".
pub fn parse_bool_literal<R: RuleType>(bool_literal_rule: Pair<R>) -> StaticScalarExpression {
