use syslog_loose::{Message, Variant, parse_message};
...
mod tests {
    ...
    fn test_rfc5424_partial_fields() {
        ...
        assert_eq!(
            parsed.msg,
            "This is a message without app, procid, and msgid"
        );
    }
    ...
    fn test_rfc5424_without_version() {
        ...
        let data =
            b"<165> 2003-08-24T05:14:15.000003-07:00 hostname app 1234 ID47 - This is the message";
        let parsed = parse_syslog_message(data);
