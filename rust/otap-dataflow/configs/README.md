...
# TCP
echo "<134>$(date '+%b %d %H:%M:%S') testhost testtag: Test message" | nc -w1 127.0.0.1 5140
```
...
# TCP
python loadgen.py --load-type syslog --syslog-server 127.0.0.1 --syslog-port 5140 --syslog-transport tcp --duration 15
```
