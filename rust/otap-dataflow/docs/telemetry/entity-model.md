...
Note: process.instance.id is currently used in the project but will be replaced
by service.instance.id in the future.
...
Attributes:
- pipeline_group.id (TBD): Pipeline group identifier.
