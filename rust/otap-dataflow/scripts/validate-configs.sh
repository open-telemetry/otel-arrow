...
if [ $# -ge 1 ]; then
    ...
    cargo build \
        --locked \
        --features azure,aws,contrib-exporters,contrib-processors,contrib-receivers,recordset-kql-processor,azure-monitor-exporter,azure-identity-auth-extension,k8s-sat-token-authorizer-extension,geneva-exporter,condense-attributes-processor,resource-validator-processor,user_events-eventheader \
