...
if [ $# -ge 1 ]; then
    ...
    cargo build \
        --features azure,aws,experimental-tls,contrib-exporters,contrib-processors,recordset-kql-processor,azure-monitor-exporter,azure-identity-auth-extension,geneva-exporter,condense-attributes-processor,resource-validator-processor \
