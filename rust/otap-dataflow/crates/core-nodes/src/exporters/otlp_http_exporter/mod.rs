...
use otap_df_common::otlp_http::client_settings::{HttpClientError, HttpClientSettings};
use otap_df_common::otlp_http::{LOGS_PATH, METRICS_PATH, PROTOBUF_CONTENT_TYPE, TRACES_PATH};
...
mod test {
    ...
    use otap_df_common::otlp_http::{HttpServerSettings, serve, tune_max_concurrent_requests};
