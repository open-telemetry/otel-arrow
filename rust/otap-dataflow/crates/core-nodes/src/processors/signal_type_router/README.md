...
- with `ack_propagation.mode: disabled`, a signal-type-router NACK remains
  local to the downstream side of the topic hop
...
The signal type router does not currently guarantee:
