...
pub fn ensure_crypto_provider() {
    ...
    INIT.call_once(|| {
        ...
        {
            otap_df_telemetry::otel_warn!("crypto.no_provider", message = "no crypto-* feature enabled: TLS operations will fail at runtime. Enable exactly one of: crypto-ring, crypto-aws-lc, crypto-openssl, crypto-symcrypt");
        }
    });
}
