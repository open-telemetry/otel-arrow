...
impl TryFrom<AuthMethod> for Arc<dyn TokenCredential> {
    type Error = azure_core::Error;

    fn try_from(value: AuthMethod) -> Result<Self, Self::Error> {
        match value {
            AuthMethod::AzureCli {
...
// TODO: Integrate with the TokenProvider in arrow-rs-object-store
