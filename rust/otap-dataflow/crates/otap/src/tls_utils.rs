...
fn parse_certified_key(
    ...
    let provider = rustls::crypto::CryptoProvider::get_default()
        .ok_or_else(|| io::Error::new(
            io::ErrorKind::Other,
            "No rustls CryptoProvider installed. Ensure a crypto feature (crypto-ring, crypto-aws-lc, or crypto-openssl) is enabled.",
        ))?;
...
mod tests {
    ...
    /// Install the appropriate rustls crypto provider for tests.
