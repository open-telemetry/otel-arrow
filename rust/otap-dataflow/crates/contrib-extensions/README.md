...
| Kubernetes SAT Authorizer | `urn:otel:extension:k8s_sat_token_authorizer` | `k8s-sat-token-authorizer-extension` | `bearer_token_authorizer` | [usage](./src/k8s_sat_token_authorizer/README.md), [design](../../docs/k8s-sat-token-authorizer-extension.md) |
