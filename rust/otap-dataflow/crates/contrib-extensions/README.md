...
| OAuth 2.0 Client Auth | `urn:otel:extension:oauth2_client_auth` | `oauth2-client-auth` | `bearer_token_provider` | [usage](./src/oauth2_client_auth/README.md), [design](./src/oauth2_client_auth/design.md) |
