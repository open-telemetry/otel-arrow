...
fn main() -> std::process::ExitCode {
    let cli = otel_arrow_dfe_ctl::Cli::parse_effective();
...
fn run(
    cli: otel_arrow_dfe_ctl::Cli,
    stdout_is_terminal: bool,
    error_format: otel_arrow_dfe_ctl::ErrorFormat,
    ...
    match runtime.block_on(otel_arrow_dfe_ctl::run_with_terminal_and_diagnostics(
        cli,
        stdout,
        stdout_is_terminal,
        stderr,
