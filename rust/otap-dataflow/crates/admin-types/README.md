...
`otel-arrow-dfe-admin-types` contains the shared request, response, query, and model
...
depend on `otel-arrow-dfe-admin-api`, which re-exports these shared model modules as
