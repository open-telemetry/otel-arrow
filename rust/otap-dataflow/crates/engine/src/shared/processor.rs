...
impl<PData> EffectHandler<PData> {
    ...
    ///
    /// Returns a scheduler-local ID that accompanies the corresponding
    /// [`crate::control::NodeControlMsg::ResumeData`]. Returns the original
    /// pdata if scheduling is rejected.
