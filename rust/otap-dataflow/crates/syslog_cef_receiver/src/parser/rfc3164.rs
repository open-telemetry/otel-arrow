...
mod tests {
    ...
    fn test_rfc3164_parsing() {
        ...
        assert_eq!(result.message, Some(b"'su root' failed for lonvick on /dev/pts/8".as_slice()));
    }
    ...
    fn test_rfc3164_content_only() {
        ...
        assert_eq!(result.content, Some(b"This is just content without colon".as_slice()));
