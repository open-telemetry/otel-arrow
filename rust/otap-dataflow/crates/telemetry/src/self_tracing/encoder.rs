...
/// Encode a single LogRecord as an OTLP ExportLogsServiceRequest also
/// known as LogsData.
///
/// The buffer is cleared before encoding. After this call, the buffer
/// contains the complete encoded request.
