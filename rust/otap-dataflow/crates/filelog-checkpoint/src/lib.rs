...
pub use primitives::{
    ...
    FILELOG_FORMAT_VERSION, FINGERPRINT_MAX_BYTES, FileId, FramingResume, LifecycleState, Locator,
    NAMESPACE_ID_MAX_BYTES, crc32c, namespace_digest,
};
pub use snapshot::{
    QuarantineEvidence, SNAPSHOT_FOOTER_BYTES, SNAPSHOT_HEADER_BYTES, Snapshot, SnapshotRecord,
